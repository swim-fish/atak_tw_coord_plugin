 ...
 * COALESCE(street→area) fix, {@code streetCandidates} matched only {@code p.street LIKE …} and these
 * rows vanished entirely; streeted rows must remain unaffected.
 *
...
public final class EmptyStreetAddressSearchTest {
  ...
  public void setUp() {
    ...
    insert(1, 24.0751, 120.5351, "彰化縣彰化市介壽里介壽新村１號", "彰化縣彰化市介壽里介壽新村1號",
        "彰化市", null, "介壽新村", "1號");
    // Another empty-street row, blank ('' not NULL) street, area 十甲巷.
    insert(2, 24.0760, 120.5360, "彰化縣彰化市十甲里十甲巷30號", "彰化縣彰化市十甲里十甲巷30號",
        "彰化市", "", "十甲巷", "30號");
    // A normal streeted row in the same district — must stay matchable & unchanged.
    insert(3, 24.0700, 120.5300, "彰化縣彰化市中山路二段100號", "彰化縣彰化市中山路二段100號",
        "彰化市", "中山路二段", null, "100號");
    facade = new SqliteAddressDatabase(db);
  }

  private void insert(
      int id, double lat, double lon, String dn, String dnHw, String township, String street,
      String area, String number) {
    db.execSQL(
        "INSERT INTO places"
