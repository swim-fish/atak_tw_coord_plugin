...
public final class TaiwanAddressResourcesTest {
  ...
  private static final int[] ADDRESS_STRING_IDS = {
    ...
    R.string.native_entry_address_locality_map_choice,
    R.string.native_entry_address_locality_clear,
    R.string.native_entry_address_locality_loading,
    R.string.native_entry_address_locality_empty,
    R.string.native_entry_address_locality_unavailable,
