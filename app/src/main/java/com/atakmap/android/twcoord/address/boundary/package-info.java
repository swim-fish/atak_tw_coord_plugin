 ...
 * com.atakmap.android.twcoord.address.boundary.TownshipBoundaryFacade} answers "which 縣市 + 鄉鎮市區 is
 * this coordinate in?" from the ~10 MB {@code townships.sqlite} (MOI boundary release 1140318) via
 * an R*Tree bbox prefilter + WKB polygon-in test, WITHOUT opening any per-county address database.
 *
