...
public enum MarkerMode {
  ...
  // Feature 003 originally added a 9th CUSTOM_ICON enum value backed by a custom in-page picker
  // (CustomIconPickerDialog). That picker was scrapped in favour of delegating to ATAK's native
  // EnterLocationDropDownReceiver (ADR-0011 D8); the delegation is a one-shot Submit-button
  // sibling on the page, not a MarkerMode enum value, so CUSTOM_ICON was removed.
