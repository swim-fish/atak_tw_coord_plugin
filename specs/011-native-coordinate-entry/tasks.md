...
## Phase 10: v1.4.1 Native Layout Hotfix
...
- [ ] T053 Run the focused native-entry suite and full Gradle gates, install v1.4.1 on ATAK 5.7.0.9, and record landscape Taipower/TWD97/TWD67 screenshots proving no elevation/footer overlap; keep ATAK 5.5 device evidence pending if unavailable (FR-022, FR-024, SC-005).
